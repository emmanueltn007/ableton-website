function About() {
  return (
    <section>
      <img
        alt=""
        class="page-about__image"
        src="https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=180"
        srcset="
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=180 180w,
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=268 268w,
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=360 360w,
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=400 400w,
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=600 600w,
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=800 800w,
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=1200 1200w,
  
    https://ableton-production.imgix.net/about/header.jpg?auto=compress%2Cformat&amp;w=1400 1400w
  ...
  "
      ...
      <div>
        <h3>
          We make Live, Push, Note, Move and Link — unique software and hardware
      ...
      <div>
        ...
        <p>
          ...
          opportunities to learn from and with each other. Alongside an internal
          training program, employees are actively supported in acquiring new
          knowledge and skills, and coached on applying these in their daily
          work. In addition, staff-organized development and music salons are a
          chance to discuss new technologies, production techniques and best
          practices.
        </p>
      </div>
      <div>
